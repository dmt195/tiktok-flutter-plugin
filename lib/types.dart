...
class ScrollEvent {
  ...
  ScrollEvent(this.direction, this.success, this.pageNo, {this.scrollPosition});

  @override
  toString() {
    return "ScrollEvent: Direction: $direction, Success: $success, Page: ${pageNo ?? "Not given"}, ScrollPosition: ${scrollPosition ?? "Not given"}";
  }
